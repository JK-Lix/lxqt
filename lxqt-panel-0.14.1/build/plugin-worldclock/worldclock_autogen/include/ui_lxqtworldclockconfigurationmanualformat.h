...
public:
    ...
    {
        LXQtWorldClockConfigurationManualFormat->setWindowTitle(QApplication::translate("LXQtWorldClockConfigurationManualFormat", "World Clock Manual Format Configuration", nullptr));
        helpL->setText(QApplication::translate("LXQtWorldClockConfigurationManualFormat", "<h1>Custom Date/Time Format Syntax</h1>\n"
...
"<br /><b>Notes:</b> <ul><li>Any characters in the pattern that are not in the "
                        "ranges of ['a'..'z'] and ['A'..'Z'] will be treated as quoted text. For instance, characters like ':', '.', ' ', '#' and '@' will appear in the resulting time text even they are not enclosed within single quotes. The single quote is used to 'escape' letters. Two single quotes in a row, whether inside or outside a quoted sequence, represent a 'real' single quote.</li><li>Minimal update interval is 1 second. If z or zzz is configured time is shown with the milliseconds fraction, but not updated on millisecond basis (avoiding big performance hit).</li><ul>\n"
"", nullptr));
    } // retranslateUi
