...
public:
    ...
    void setupUi(QDialog *LXQtWorldClockConfiguration)
    {
        ...
        LXQtWorldClockConfiguration->resize(600, 686);
        ...
        QWidget::setTabOrder(autorotateCB, buttons);
    ...
    {
        LXQtWorldClockConfiguration->setWindowTitle(QApplication::translate("LXQtWorldClockConfiguration", "World Clock Settings", nullptr));
        timeGB->setTitle(QApplication::translate("LXQtWorldClockConfiguration", "&Time", nullptr));
        timeFormatL->setText(QApplication::translate("LXQtWorldClockConfiguration", "F&ormat:", nullptr));
        timeFormatCB->setItemText(0, QApplication::translate("LXQtWorldClockConfiguration", "Short", nullptr));
        timeFormatCB->setItemText(1, QApplication::translate("LXQtWorldClockConfiguration", "Long", nullptr));
        timeFormatCB->setItemText(2, QApplication::translate("LXQtWorldClockConfiguration", "Custom", nullptr));

        timeShowSecondsCB->setText(QApplication::translate("LXQtWorldClockConfiguration", "Sho&w seconds", nullptr));
        timePadHourCB->setText(QApplication::translate("LXQtWorldClockConfiguration", "Pad &hour with zero", nullptr));
        timeAMPMCB->setText(QApplication::translate("LXQtWorldClockConfiguration", "&Use 12-hour format", nullptr));
        timezoneGB->setTitle(QApplication::translate("LXQtWorldClockConfiguration", "T&ime zone", nullptr));
        timezonePositionL->setText(QApplication::translate("LXQtWorldClockConfiguration", "&Position:", nullptr));
        timezoneFormatL->setText(QApplication::translate("LXQtWorldClockConfiguration", "For&mat:", nullptr));
        timezonePositionCB->setItemText(0, QApplication::translate("LXQtWorldClockConfiguration", "Below", nullptr));
        timezonePositionCB->setItemText(1, QApplication::translate("LXQtWorldClockConfiguration", "Above", nullptr));
        timezonePositionCB->setItemText(2, QApplication::translate("LXQtWorldClockConfiguration", "Before", nullptr));
        timezonePositionCB->setItemText(3, QApplication::translate("LXQtWorldClockConfiguration", "After", nullptr));

        timezoneFormatCB->setItemText(0, QApplication::translate("LXQtWorldClockConfiguration", "Short", nullptr));
        timezoneFormatCB->setItemText(1, QApplication::translate("LXQtWorldClockConfiguration", "Long", nullptr));
        timezoneFormatCB->setItemText(2, QApplication::translate("LXQtWorldClockConfiguration", "Offset from UTC", nullptr));
        timezoneFormatCB->setItemText(3, QApplication::translate("LXQtWorldClockConfiguration", "Abbreviation", nullptr));
        timezoneFormatCB->setItemText(4, QApplication::translate("LXQtWorldClockConfiguration", "Location identifier", nullptr));
        timezoneFormatCB->setItemText(5, QApplication::translate("LXQtWorldClockConfiguration", "Custom name", nullptr));

        dateGB->setTitle(QApplication::translate("LXQtWorldClockConfiguration", "&Date", nullptr));
        datePositionL->setText(QApplication::translate("LXQtWorldClockConfiguration", "Po&sition:", nullptr));
        datePositionCB->setItemText(0, QApplication::translate("LXQtWorldClockConfiguration", "Below", nullptr));
        datePositionCB->setItemText(1, QApplication::translate("LXQtWorldClockConfiguration", "Above", nullptr));
        datePositionCB->setItemText(2, QApplication::translate("LXQtWorldClockConfiguration", "Before", nullptr));
        datePositionCB->setItemText(3, QApplication::translate("LXQtWorldClockConfiguration", "After", nullptr));

        dateFormatL->setText(QApplication::translate("LXQtWorldClockConfiguration", "Fo&rmat:", nullptr));
        dateFormatCB->setItemText(0, QApplication::translate("LXQtWorldClockConfiguration", "Short", nullptr));
        dateFormatCB->setItemText(1, QApplication::translate("LXQtWorldClockConfiguration", "Long", nullptr));
        dateFormatCB->setItemText(2, QApplication::translate("LXQtWorldClockConfiguration", "ISO 8601", nullptr));
        dateFormatCB->setItemText(3, QApplication::translate("LXQtWorldClockConfiguration", "Custom", nullptr));

        dateShowYearCB->setText(QApplication::translate("LXQtWorldClockConfiguration", "Show &year", nullptr));
        dateShowDoWCB->setText(QApplication::translate("LXQtWorldClockConfiguration", "Show day of wee&k", nullptr));
        datePadDayCB->setText(QApplication::translate("LXQtWorldClockConfiguration", "Pad d&ay with zero", nullptr));
        dateLongNamesCB->setText(QApplication::translate("LXQtWorldClockConfiguration", "&Long month and day of week names", nullptr));
        advancedManualGB->setTitle(QApplication::translate("LXQtWorldClockConfiguration", "Ad&vanced manual format", nullptr));
        customisePB->setText(QApplication::translate("LXQtWorldClockConfiguration", "&Customise ...", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(displayFormatT), QApplication::translate("LXQtWorldClockConfiguration", "Display &format", nullptr));
        QTableWidgetItem *___qtablewidgetitem = timeZonesTW->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("LXQtWorldClockConfiguration", "IANA id", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = timeZonesTW->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("LXQtWorldClockConfiguration", "Custom name", nullptr));
        addPB->setText(QApplication::translate("LXQtWorldClockConfiguration", "&Add ...", nullptr));
        removePB->setText(QApplication::translate("LXQtWorldClockConfiguration", "&Remove", nullptr));
        setAsDefaultPB->setText(QApplication::translate("LXQtWorldClockConfiguration", "Set as &default", nullptr));
        editCustomNamePB->setText(QApplication::translate("LXQtWorldClockConfiguration", "&Edit custom name ...", nullptr));
        moveUpPB->setText(QApplication::translate("LXQtWorldClockConfiguration", "Move &up", nullptr));
        moveDownPB->setText(QApplication::translate("LXQtWorldClockConfiguration", "Move do&wn", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(timeZonesT), QApplication::translate("LXQtWorldClockConfiguration", "Time &zones", nullptr));
        autorotateCB->setText(QApplication::translate("LXQtWorldClockConfiguration", "Auto&rotate when the panel is vertical", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(generalT), QApplication::translate("LXQtWorldClockConfiguration", "&General", nullptr));
    } // retranslateUi
