...
public:
    ...
    {
        LXQtWorldClockConfigurationTimeZones->setWindowTitle(QApplication::translate("LXQtWorldClockConfigurationTimeZones", "World Clock Time Zones", nullptr));
        QTreeWidgetItem *___qtreewidgetitem = timeZonesTW->headerItem();
        ___qtreewidgetitem->setText(3, QApplication::translate("LXQtWorldClockConfigurationTimeZones", "Country", nullptr));
        ___qtreewidgetitem->setText(2, QApplication::translate("LXQtWorldClockConfigurationTimeZones", "Comment", nullptr));
        ___qtreewidgetitem->setText(1, QApplication::translate("LXQtWorldClockConfigurationTimeZones", "Name", nullptr));
        ___qtreewidgetitem->setText(0, QApplication::translate("LXQtWorldClockConfigurationTimeZones", "Time zone", nullptr));
    } // retranslateUi
