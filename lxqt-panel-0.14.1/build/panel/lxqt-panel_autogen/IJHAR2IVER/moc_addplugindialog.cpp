...
#include "config/addplugindialog.h"
...
QT_MOC_LITERAL(3, 32, 16), // "LXQt::PluginInfo"
...
QT_MOC_LITERAL(6, 63, 18) // "emitPluginSelected"
    ...
    "LXQt::PluginInfo\0plugin\0filter\0"
    "emitPluginSelected"
};
...
void AddPluginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pluginSelected((*reinterpret_cast< const LXQt::PluginInfo(*)>(_a[1]))); break;
        ...
        {
            using _t = void (AddPluginDialog::*)(const LXQt::PluginInfo & );
...
// SIGNAL 0
void AddPluginDialog::pluginSelected(const LXQt::PluginInfo & _t1)
{
